...
enum AppI18n {
    ...
    private static let extraStrings: [String: [String: String]] = [
        "ko": [
            ...
            "spotify.api.desc_ios": "Android와 동일하게 Spotify Client ID와 Client Secret을 저장해야 ISRC 검색, Spotify 메타데이터 보강, LRCLIB 매칭이 안정적으로 동작합니다.",
            ...
            "spotify.status_credentials_saved": "Spotify API 정보가 저장되었습니다.",
            "spotify.status_credentials_required": "Client ID와 Client Secret이 모두 필요합니다.",
            ...
            "spotify.step4.desc": "API 선택 영역에서 Web API를 선택하고, iOS SDK/App Remote 사용을 위해 iOS 번들 정보를 저장한 뒤 Save를 누르세요.",
            "spotify.step5.title": "Client ID와 Secret 복사",
            "spotify.step5.desc": "생성된 앱의 Settings에서 Client ID와 Client Secret을 복사한 뒤, 아래 입력칸에 붙여넣고 Spotify API 확인을 누르세요.",
        ...
        "en": [
            ...
            "spotify.api.title": "Spotify API",
            "spotify.api.desc_ios": "As on Android, Spotify Client ID and Client Secret are required for reliable ISRC lookup, Spotify metadata enrichment, and LRCLIB matching.",
            ...
            "spotify.status_credentials_saved": "Spotify API credentials saved.",
            "spotify.status_credentials_required": "Client ID and Client Secret are required.",
            ...
            "spotify.step4.desc": "Select Web API, keep the iOS SDK/App Remote app details saved, then press Save.",
            "spotify.step5.title": "Copy Client ID and Secret",
            "spotify.step5.desc": "Copy Client ID and Client Secret from the app settings, paste them below, then validate Spotify API.",
            "spotify.copy.dashboard_url": "Dashboard URL",
            "spotify.copy.app_name": "App name",
            "spotify.copy.app_description": "App description",
            "spotify.copy.redirect_uri": "Redirect URI",
