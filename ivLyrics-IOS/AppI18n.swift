...
enum AppI18n {
    ...
    private static let extraStrings: [String: [String: String]] = [
        "ko": [
            ...
            "lyrics_provider.mode.multi": "여러 공급자",
            "lyrics_provider.remote_not_authorized": "서명 검증된 원격 승인이 없어 기존 방식으로 안전하게 동작합니다.",
            "lyrics_provider.enable_format": "%@ 사용",
            "lyrics_provider.unofficial_provider_desc": "비공식 API이며 기본적으로 꺼져 있습니다. 서비스 정책이나 형식 변경으로 언제든 중단될 수 있습니다.",
            "lyrics_provider.order": "공급자 우선순위",
            "lyrics_provider.order_desc": "동기화 품질이 같을 때 위쪽 공급자를 먼저 선택합니다.",
            "lyrics_provider.deezer_arl": "Deezer ARL",
            "lyrics_provider.deezer_arl_desc": "직접 제공한 ARL만 Keychain에 저장합니다. 앱 설정, 캐시, 로그에는 값을 남기지 않습니다.",
            "lyrics_provider.deezer_arl_placeholder": "ARL 입력",
            "lyrics_provider.deezer_configured": "구성됨 · 값은 표시하지 않습니다",
            "lyrics_provider.deezer_not_configured": "구성되지 않음 · Deezer 네트워크 요청을 보내지 않습니다",
            "lyrics_provider.deezer_save": "ARL 안전하게 저장",
            "lyrics_provider.deezer_remove": "ARL 삭제",
            "lyrics_provider.deezer_saved": "ARL이 Keychain에 저장되었습니다.",
            ...
            "spotify.setup.step4.title": "iOS 선택 후 저장",
            "spotify.setup.step4.desc": "API/SDK 선택 영역에서 iOS를 선택하고 번들 ID를 저장하세요. Spotify Web API 설정을 켤 계획이라면 Web API도 함께 선택하세요.",
            "spotify.setup.step5.title": "Client ID 복사",
            "spotify.setup.step5.desc": "앱 설정에서 Client ID를 복사하세요. Client Secret은 ISRC와 메타데이터 보강이 필요할 때만 선택적으로 입력합니다.",
        ...
        "en": [
            ...
            "lyrics_provider.mode.multi": "Multiple providers",
            "lyrics_provider.remote_not_authorized": "Verified remote approval is unavailable, so the existing flow remains active.",
            "lyrics_provider.enable_format": "Enable %@",
            "lyrics_provider.unofficial_provider_desc": "Uses an unofficial API and is off by default. Service policy or format changes may disable it at any time.",
            "lyrics_provider.order": "Provider priority",
            "lyrics_provider.order_desc": "When timing quality is equal, providers higher in this list are preferred.",
            "lyrics_provider.deezer_arl": "Deezer ARL",
            "lyrics_provider.deezer_arl_desc": "Only the ARL you provide is stored in Keychain. It is never written to settings, caches, or logs.",
            "lyrics_provider.deezer_arl_placeholder": "Enter ARL",
            "lyrics_provider.deezer_configured": "Configured · value is hidden",
            "lyrics_provider.deezer_not_configured": "Not configured · no Deezer network requests are made",
            "lyrics_provider.deezer_save": "Save ARL securely",
            "lyrics_provider.deezer_remove": "Remove ARL",
            "lyrics_provider.deezer_saved": "The ARL was saved in Keychain.",
            ...
            "spotify.setup.step4.title": "Select iOS and save",
            "spotify.setup.step4.desc": "Select iOS under APIs/SDKs and save the bundle ID. Also select Web API if you plan to turn on the Spotify Web API setting.",
            "spotify.setup.step5.title": "Copy the Client ID",
            "spotify.setup.step5.desc": "Copy the Client ID from the app settings. Add the Client Secret only if you want ISRC and metadata enrichment.",
